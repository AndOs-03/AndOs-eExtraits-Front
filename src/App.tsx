...
import Connexion from "./pages/AuthPages/Connexion.tsx";
import CreerCompteUtilisateur from "./pages/AuthPages/CreerCompteUtilisateur.tsx";
      ...
      <>
        <Router>
          ...
          <Routes>
            ...
            <Route path="/register" element={<CreerCompteUtilisateur/>}/>

              ...
              <div className="p-6 py-1 rounded-lg shadow-md mb-2 border border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-2">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-2">
                    ...
                    <div className="mb-2">
                      <label
                          className="block text-sm font-medium text-gray-700 mb-1">Registre</label>
                      <input
                          type="text"
                  ...
                  <div className="mb-2">
                    <label className="block text-sm font-medium text-gray-700 mb-1">État
                      Civil</label>
                    <input
                        type="text"
                ...
                {extraitTPI ? (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-2">
                      <div className="mb-2">
                        <label className="block text-sm font-medium text-gray-700 mb-1">J.S
                          Nº</label>
                        <input
                            type="text"
                            placeholder="Nº J.S"
